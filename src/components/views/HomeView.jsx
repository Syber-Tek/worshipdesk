...
export default function HomeView({
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto pb-6">
      ...
      <div className={`p-5 rounded-xl border flex flex-col md:flex-row items-start md:items-center justify-between gap-4 transition-colors duration-200 ${cardClass}`}>
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            className="px-3.5 py-2 bg-[#D4A94A] hover:bg-[#E2B757] text-[#0B0C0E] font-bold text-xs rounded-lg flex items-center gap-1.5 shadow transition cursor-pointer"
          >
