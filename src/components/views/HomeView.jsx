      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className={`p-4 rounded-xl border space-y-3 ${cardClass}`}>
          ...
          <div className="pt-2 border-t border-border flex justify-between items-center text-[10px]">
            ...
            <button onClick={() => setActiveTab('plan')} className="text-accent hover:underline flex items-center gap-0.5">
        ...
        <div className={`p-4 rounded-xl border space-y-3 ${cardClass}`}>
          ...
          <div className="pt-2 border-t border-border flex justify-between items-center text-[10px]">
            ...
            <button onClick={() => setActiveTab('bible')} className="text-accent hover:underline flex items-center gap-0.5">
        ...
        <div className={`p-4 rounded-xl border space-y-3 ${cardClass}`}>
          ...
          <div className="pt-2 border-t border-border flex justify-between items-center text-[10px]">
            ...
            <button onClick={() => setActiveTab('songs')} className="text-accent hover:underline flex items-center gap-0.5">
        ...
        <div className={`p-4 rounded-xl border space-y-3 ${cardClass}`}>
          ...
          <div className="pt-2 border-t border-border flex justify-between items-center text-[10px]">
            <span className={displays.length > 1 ? 'text-success font-medium' : labelClass}>
              {displays.length > 1 ? 'Projector Synced' : 'Control Window'}
            </span>
            <button onClick={() => setActiveTab('settings')} className="text-accent hover:underline flex items-center gap-0.5">
                ...
                {playlist.slice(0, 4).map((item, index) => (
                  ...
                  >
                    <div className="flex items-center gap-2.5 min-w-0 flex-1">
                      <span className="font-mono text-[10px] text-accent font-bold">#{index + 1}</span>
          ...
          <div className={`p-4 rounded-xl border space-y-3.5 ${cardClass}`}>
            <div className="flex justify-between items-center border-b pb-2.5 border-border">
              ...
              <span className={`px-1.5 py-0.5 rounded text-[9px] font-bold ${
                isLive ? 'bg-live text-white animate-pulse' : 'bg-raised text-text-muted'
              }`}>
          ...
          <div className={`p-4 rounded-xl border space-y-3 ${cardClass}`}>
            ...
            <div className="space-y-2 text-xs">
              <div className={`p-2.5 rounded-lg border flex items-center justify-between ${innerCardClass}`}>
                ...
                <span className="text-[10px] font-bold text-success bg-success/15 px-1.5 py-0.5 rounded">5 XMLs</span>
              </div>
              <div className={`p-2.5 rounded-lg border flex items-center justify-between ${innerCardClass}`}>
                <span className={headingClass}>Presby & Methodist Hymnal</span>
                <span className="text-[10px] font-bold text-accent bg-accent/15 px-1.5 py-0.5 rounded">855 .sng</span>
              </div>
              <div className={`p-2.5 rounded-lg border flex items-center justify-between ${innerCardClass}`}>
                <span className={headingClass}>Offline SQLite Database</span>
                <span className="text-[10px] font-bold text-success bg-success/15 px-1.5 py-0.5 rounded">WAL Mode</span>
              </div>
            </div>
          </div>
        </div>
