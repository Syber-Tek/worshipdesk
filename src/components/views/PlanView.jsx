      ...
      <div className={`p-5 rounded-lg border space-y-4 transition-colors duration-200 ${
        ...
        <div className={`flex justify-between items-center border-b pb-3 ${
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-accent hover:bg-accent/90 text-bg rounded font-semibold text-xs transition shadow cursor-pointer"
          >
        ...
        {playlist.length === 0 ? (
          <div className={`p-8 rounded-lg border text-center space-y-3 ${
            ...
            <button
              onClick={() => setShowAddModal(true)}
              className="px-4 py-2 bg-accent text-bg font-semibold text-xs rounded shadow hover:bg-accent/90 transition cursor-pointer"
            >
              ...
              >
                ...
                <div className="flex items-center gap-1">
                  ...
                  <button
                    ...
                    className="p-1 bg-accent hover:bg-accent/90 text-bg rounded transition shadow cursor-pointer"
                  >
